...
permalink: /fzu_cs_course/computer-organization/
---
# 第一章 计算机系统概述
...
2. 改进方法
   ...
   - 设: $\begin{cases}G_i = A_i B_i&\textcolor{#66ccff}{\text{进位发生输出信号}}\\ P_i = A_i\oplus B_i &\textcolor{#66ccff}{\text{进位传送输出信号}}\end{cases}$
